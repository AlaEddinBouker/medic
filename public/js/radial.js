(window.webpackJsonp = window.webpackJsonp || []).push([[22], {
    144: function (t, i, s) {
        ...
        "use strict";
        s.r(i);
        var h = s(0), d = s.n(h), e = (s(223), s(9)), v = s.n(e);
        s(144);
        d()(function () {
            var t = {
                width: "50%",
            ...
            d()("#knob-chart1").knob(t), d()("#knob-chart2").knob(i), d()("#knob-chart3").knob(s), d()("#knob-chart4").knob(h);
            var e = {
                ...
                lineWidth: 15,
                lineCap: "circle"
            }, r = document.querySelector("#easypiechart1");
            new v.a(r, e);
            var l = document.querySelector("#easypiechart2");
            new v.a(l, n);
            var c = document.querySelector("#easypiechart3");
            new v.a(c, a);
            var u = document.querySelector("#easypiechart4");
            new v.a(u, o)
        })
    }, 223: function (t, i, s) {
        /*!jQuery Knob*/
        t.exports = function (c) {
            ...
            s.c = {}, s.c.d = c(document), s.c.t = function (t) {
                ...
                s.o.call(this), this.startAngle = null, this.xy = null, this.radius = null, this.lineWidth = null, this.cursorExt = null, this.w2 = null, this.PI2 = 2 * Math.PI, this.extend = function () {
                    this.o = c.extend({
                    ...
                    t = this.o.parse(t), !1 !== i && t != this.v && this.rH && !1 === this.rH(t) || (this.cv = this.o.stopper ? u(d(t, this.o.max), this.o.min) : t, this.v = this.cv, this.$.val(this.o.format(this.v)), this._draw())
                }, this.xy2val = function (t, i) {
                    var s, h;
                    return s = Math.atan2(t - (this.x + this.w2), -(i - this.y - this.w2)) - this.angleOffset, this.o.flip && (s = this.angleArc - s - this.PI2), this.angleArc != this.PI2 && s < 0 && -.5 < s ? s = 0 : s < 0 && (s += this.PI2), h = s * (this.o.max - this.o.min) / this.angleArc + this.o.min, this.o.stopper && (h = u(d(h, this.o.max), this.o.min)), h
                }, this.listen = function () {
                    var n, a, h, e, o = this, t = function (t) {
                        t.preventDefault();
                        var i = t.originalEvent, s = i.detail || i.wheelDeltaX, h = i.detail || i.wheelDeltaY,
                            e = o._validate(o.o.parse(o.$.val())) + (0 < s || 0 < h ? o.o.step : s < 0 || h < 0 ? -o.o.step : 0);
                        e = u(d(e, o.o.max), o.o.min), o.val(e, !1), o.rH && (clearTimeout(n), n = setTimeout(function () {
                            o.rH(e), n = null
                        }, 100), a || (a = setTimeout(function () {
                            n && o.rH(e), a = null
                        }, 200)))
                    }, r = 1, l = {37: -o.o.step, 38: o.o.step, 39: o.o.step, 40: -o.o.step};
                    this.$.bind("keydown", function (t) {
                        var i = t.keyCode;
                        if (96 <= i && i <= 105 && (i = t.keyCode = i - 48), h = parseInt(String.fromCharCode(i)), isNaN(h) && (13 !== i && 8 !== i && 9 !== i && 189 !== i && (190 !== i || o.$.val().match(/\./)) && t.preventDefault(), -1 < c.inArray(i, [37, 38, 39, 40]))) {
                            t.preventDefault();
                            var s = o.o.parse(o.$.val()) + l[i] * r;
                            o.o.stopper && (s = u(d(s, o.o.max), o.o.min)), o.change(o._validate(s)), o._draw(), e = window.setTimeout(function () {
                                r *= 2
                            }, 30)
                        }
                    }).bind("keyup", function (t) {
                        isNaN(h) ? e && (window.clearTimeout(e), e = null, r = 1, o.val(o.$.val())) : o.$.val() > o.o.max && o.$.val(o.o.max) || o.$.val() < o.o.min && o.$.val(o.o.min)
                    ...
                    var i, s;
                    return t = this.angle(t), s = this.o.flip ? (i = this.endAngle + 1e-5) - t - 1e-5 : (i = this.startAngle - 1e-5) + t + 1e-5, this.o.cursor && (i = s - this.cursorExt) && (s += this.cursorExt), {
                        s: i,
                        e: s,
