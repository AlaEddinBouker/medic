                ...
                @if (session()->has('success_message'))
                    ...
                    <div class="tab">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="hairStatue" placeholder="Hair Status" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                    ...
                    <div class="tab">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <input type="radio" id="payment" name="payment" checked>&nbsp;&nbsp;<strong>Virement Banquaire</strong>
                        </div>
