    ...
    <aside class="sidebar-container">
        ...
        <div class="sidebar-content">
            <div class="sidebar-toolbar text-center">
                ...
                <div class="mt"><span data-i18n="user.WELCOME">Welcome</span><span>, {{Auth::user()->name}}</span></div>
            </div>
                ...
                <ul>
                    ...
                    <li>
                        <a class="ripple" href="#">
                            ...
                            <span class="nav-icon">
                                <img class="invisible" data-svg-replace="src/images/connection-bars.svg" alt="MenuItem">
                            </span>
                            <span>Users</span>
                        </a>
                        <ul
                    ...
                    <li>
                        ...
                        <ul
                            ...
                            <li>
                                <a class="ripple" href="{{url('/roles')}}"><span class="float-right nav-label"></span><span>Roles list</span></a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul
                            ...
                            <li>
                                <a class="ripple" href="radial.html"><span class="float-right nav-label"></span><span>Patiens list</span></a>
                            </li>
    ...
    <main class="main-container">
        <section>
            <div class="content-heading bg-white">
                <div class="row">
                    <div class="col-sm-9">
                        <h4 class="m0 text-thin"><span class="mr-1" data-i18n="WELCOME">Welcome to</span><span>BENSINA dashboard</span>
                        </h4>
